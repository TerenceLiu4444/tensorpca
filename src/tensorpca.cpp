...
Rcpp::List TensorPCA(SEXP X,
  ...
  // Creats place holders for decomposed tensor eigen values and 
  ...
  // Obtains initial guess on v and w.
  ...
  arma::mat eigen_vecs_d1_init(dims[1], tensor_rank);
  arma::mat eigen_vecs_d2_init(dims[2], tensor_rank);
